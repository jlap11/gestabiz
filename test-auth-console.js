...
console.log('%c INICIANDO TEST DE AUTENTICACIÓN', 'background: #222; color: #00ff00; font-size: 16px; padding: 10px;');

// Test 1: Verificar sesión actual
const testAuth = async () => {
  console.log('\n%c Test 1: Verificar Sesión Actual', 'background: #333; color: #ffff00; font-size: 14px; padding: 5px;');
...
const testBusinessInsert = async (sessionData) => {
  console.log('\n%c Test 2: Test INSERT en businesses', 'background: #333; color: #ffff00; font-size: 14px; padding: 5px;');
...
const testRLSPolicies = async () => {
  console.log('\n%c Test 3: Verificar Políticas RLS', 'background: #333; color: #ffff00; font-size: 14px; padding: 5px;');
...
const runAllTests = async () => {
  try {
    ...
    console.log('\n%c TESTS COMPLETADOS', 'background: #222; color: #00ff00; font-size: 16px; padding: 10px;');
    console.log('%cAhora copia TODOS los resultados y compártelos', 'color: #ffff00; font-size: 14px;');
  } catch (err) {
