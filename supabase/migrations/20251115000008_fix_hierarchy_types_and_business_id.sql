-- Migration: Fix get_business_hierarchy types and add business_id
-- Fecha: 2025-11-15
-- Fase: 2 - Sistema de Nómina - Correción de tipos
...
RETURNS TABLE (
  ...
  location_name TEXT,
  is_active BOOLEAN,
  hired_at TIMESTAMP WITH TIME ZONE,  -- ⭐ CORREGIDO (era DATE)
  salary_base NUMERIC,
  salary_type VARCHAR,
