  ...
  this_quarter: 'This Quarter',
    ...
    hierarchy: {
      ...
      locationActions: {
        ...
        loadSeatError: 'Error loading seats',
        seatNameRequired: 'Seat name is required',
      },
  ...
  this_quarter: 'Este Trimestre',
    ...
    admin: {
      ...
      locationActions: {
        ...
        loadSeatError: 'Error al cargar las sedes',
        seatNameRequired: 'El nombre de la sede es requerido',
      },
