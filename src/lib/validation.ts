...
export const validators = {
  ...
  passwordConfirmation: (password: string) => (confirmation: string): ValidationResult => {
...
export const appointmentSchema = new ValidationSchema()
  .field('client_name').required().minLength(2).maxLength(100)
  .field('client_email').email()
  .field('client_phone').phone()
  .field('start_time').required().time()
  .field('end_time').required().time()
  .field('date').required().date().futureDate()
...
export const businessSchema = new ValidationSchema()
  ...
  .field('address').required().minLength(5).maxLength(200)
  .field('city').required().minLength(2).maxLength(50)
  .field('country').required().minLength(2).maxLength(50)
  .field('website').url()
...
export const clientSchema = new ValidationSchema()
  ...
  .field('address').maxLength(200)

export const serviceSchema = new ValidationSchema()
  .field('name').required().minLength(2).maxLength(100)
  .field('description').maxLength(500)
  .field('duration').required().min(5).max(480) // 5 minutes to 8 hours
  .field('price').required().min(0)
  .field('category').required().minLength(2).maxLength(50)
...
export const passwordChangeSchema = new ValidationSchema()
  .field('currentPassword').required()
  .field('newPassword').required().password()
  .field('confirmPassword').required()
  .field('confirmPassword').custom((value) => {
