...
export function BusinessSelection({
  ...
  if (businesses.length === 0) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-muted-foreground">There are no active businesses at the moment.</p>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Título */}
      <div>
        <h3 className="text-xl font-semibold text-foreground mb-2">Select a Business</h3>
            ...
            return (
              ...
              >
                ...
                <div className="p-4 bg-muted/50">
                  <h3 className="text-base font-semibold text-foreground mb-1">{business.name}</h3>
                  ...
                  <div className="space-y-1">
                    ...
                    {business.phone && (
                      <p className="text-xs text-[#64748b]">📞 {business.phone}</p>
                    )}
                  </div>
                </div>
              </Card>
