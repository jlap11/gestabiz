...
import { Ban, Briefcase, Check, Loader2, Star, UserCircle2, Users } from 'lucide-react'
...
export function EmployeeSelection({
    ...
    const fetchEmployeesForService = async () => {
      ...
      try {
        ...
        const reviewStats = reviews?.reduce(
          (acc: Record<string, { avg: number; count: number }>, review) => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-foreground mb-2">Selecciona un Profesional</h3>
