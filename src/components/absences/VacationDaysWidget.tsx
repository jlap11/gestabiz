      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <p className="text-sm">{t('absences.vacationWidget.noInfo')}</p>
          </div>
        </CardContent>
      </Card>
    )
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-xs text-muted-foreground">
            <span>{t('absences.vacationWidget.used')}</span>
            <span>{t('absences.vacationWidget.pending')}</span>
          </div>
          <div className="h-3 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden flex">
            <div
              ...
              title={`${Math.max(0, balance.daysUsed)} ${t('absences.vacationWidget.daysUsed')}`}
            />
            <div
            ...
            <div
              ...
              title={`${Math.max(0, balance.daysRemaining)} ${t('absences.vacationWidget.daysAvailable')}`}
            />
          </div>
        </div>
