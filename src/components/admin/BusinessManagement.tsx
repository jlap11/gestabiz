...
import { Building, MapPin, Plus, Gear as Settings, Star, Trash } from '@phosphor-icons/react'
        ...
        <TabsContent value="business" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('business.management.info_description')}</CardDescription>
            </CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {locations.length}{' '}
                  {locations.length === 1 ? t('locations.main_location') : t('locations.title')}
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {services.length}{' '}
                  {services.length === 1 ? t('services.new_service') : t('services.title')}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          handleUpdateService({ duration: parseInt(e.target.value) || 0 })
                        }
                        min="5"
                        step="5"
                      />
                    ...
                    <div>
                      ...
                      <div className="flex">
                        ...
                        <Input
                          ...
                          onChange={e =>
                            handleUpdateService({ price: parseFloat(e.target.value) || 0 })
                          }
                          min="0"
                          step="1000"
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('business.management.settings_description')}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    step="15"
                  />
                  <p className="text-sm text-muted-foreground mt-1">{t('appointments.duration')}</p>
                </div>
