...
const testUsers: TestUser[] = [
  ...
  },
  {
    ...
    name: 'Miguel Romero',
    phone: '+52 55 1212 3434',
    role: 'employee',
  },
  {
    email: 'adriana.silva@example.com',
    name: 'Adriana Silva',
    phone: '+52 33 5656 7878',
    role: 'employee',
  },
  {
  ...
  {
    email: 'larissa.gutierrez@example.com',
    name: 'Larissa Gutiérrez',
    phone: '+52 55 3434 5656',
    role: 'employee',
  },
  {
    email: 'oscar.navarro@example.com',
    name: 'Oscar Navarro',
    phone: '+52 33 7878 9090',
    role: 'employee',
  },
  ...
  {
    email: 'alberto.vega@example.com',
    name: 'Alberto Vega',
  ...
  {
    email: 'teresa.flores@example.com',
    name: 'Teresa Flores',
    phone: '+52 33 4682 5791',
    role: 'client',
  },
  {
    email: 'emilio.santos@example.com',
    name: 'Emilio Santos',
    phone: '+52 81 7139 4826',
    role: 'client',
  },
]
      ...
      <CardContent className="space-y-6">
        {!isCreating && results.success === 0 && results.errors.length === 0 && (
          <div className="space-y-4">
            ...
            <Button onClick={createTestUsers} className="w-full" variant="default">
        ...
        {isCreating && (
          <div className="space-y-4">
            ...
            {currentUser && <p className="text-sm text-gray-600">Creando: {currentUser}</p>}
          </div>
        )}
            ...
            <Alert className={results.errors.length > 0 ? 'border-orange-200' : 'border-green-200'}>
              <AlertDescription>
                ...
                {results.errors.length > 0 && (
                  <>
                    <br />❌ <strong>{results.errors.length} errores encontrados</strong>
                  </>
                )}
              </AlertDescription>
            </Alert>
