...
import type { Business, LegalEntityType, User, UserRole } from '@/types/types'
...
import { compressImageForBanner, compressImageForLogo } from '@/lib/imageCompression'
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold tracking-tight text-foreground">
              {t('admin.actions.createBusiness')}
            </h1>
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-card border-border">
                <CardHeader>
                  ...
                  <CardDescription className="text-muted-foreground">
                    Datos legales para Colombia (opcional pero recomendado). Diferente a la
              ...
              <Card className="bg-card border-border">
                <CardHeader>
                  ...
                  <CardDescription className="text-muted-foreground">
                    Sube un banner panorámico para tu negocio (opcional, se subirá al crear el
                    negocio)
                  </CardDescription>
                </CardHeader>
                <CardContent>
