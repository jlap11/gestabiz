...
function Input({ className, type, ...props }: ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // Use semantic variables so dark/light themes apply predictably.
        // Ensure the input has an explicit background and text color in dark mode
        // to avoid inheriting a white background when focused/typing.
