      ...
      <AlertDialogContent className="max-w-2xl">
        <AlertDialogHeader>
          <AlertDialogTitle className="text-2xl">
            ¿Seleccionar como empleado?
          </AlertDialogTitle>
          <AlertDialogDescription className="space-y-4 pt-4">
            <p className="text-base">
              Estás a punto de seleccionar a <strong className="text-foreground">{candidateName}</strong>
              {' '}como empleado para la vacante{' '}
              ...
              <AlertDescription className="text-orange-900 dark:text-orange-100 mt-2">
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  {otherCandidatesCount > 0 && (
                    <li>
                      Los demás candidatos en proceso ({otherCandidatesCount}) serán notificados del rechazo
                    </li>
                  )}
                ...
                <AlertTitle className="text-blue-900 dark:text-blue-100 font-semibold">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      ...
                      } recibirá{otherCandidatesCount === 1 ? '' : 'n'} un email informándoles la decisión
                    </li>
                    <li>
                      Todos recibirán notificaciones in-app
                    </li>
                  </ul>
                </AlertDescription>
              </Alert>
