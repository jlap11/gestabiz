...
# AppointmentPro Complete Setup Script
# This script helps set up the complete AppointmentPro ecosystem
...
package_extension() {
    ...
    if [ -d "src/browser-extension" ]; then
        ...
        cd dist
        zip -r appointmentpro-extension.zip extension/
        cd ..
        
        print_status "Extension packaged as dist/appointmentpro-extension.zip"
    else
...
deploy_production() {
    ...
    echo "   - Upload dist/appointmentpro-extension.zip to Chrome Web Store"
    echo ""
